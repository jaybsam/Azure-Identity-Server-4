...
namespace Toll.portal.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var idToken = Microsoft.AspNetCore.Authentication.AuthenticationHttpContextExtensions.GetTokenAsync(HttpContext, "id_token");
            ...
            return View();
            //return Redirect("http://localhost:4200/id_token="+ idToken.Result + "&accesstoken="+ accessToken.Result);
            // return View();
        }
